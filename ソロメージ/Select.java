...
public class Select extends JFrame implements Runnable{
	...
	private String[] aa = {"","  [1]   Žì‚ð“Ç‚Þ(‚½‚Ü‚ð‚æ‚Þ)", "  [2]   ‘«‚µŽZ(‚½‚µ‚´‚ñ)", "  [3]   ˆø‚«ŽZ(‚Ð‚«‚´‚ñ)"};
	public void run(){
...
//			JButton bt = new JButton(ra);
	...
	class ClickAction extends AbstractAction{
		...
		public ClickAction( Select w, int index, InputMap imap, ActionMap amap, CalcTest_pre calc){
			...
			Action num1 = new NumKey("  [1]   Žì‚ð“Ç‚Þ(‚½‚Ü‚ð‚æ‚Þ)", this.w, this.calc);
			Action num2 = new NumKey("  [2]   ‘«‚µŽZ(‚½‚µ‚´‚ñ)", this.w, this.calc);
			Action num3 = new NumKey("  [3]   ˆø‚«ŽZ(‚Ð‚«‚´‚ñ)", this.w, this.calc);
