...
public class Select3 extends JFrame implements Runnable{
	...
	private String[] aa = {"", "  [1]   1ïb(Ç—ÇÂÇ§)", "  [2]   2ïb(Ç—ÇÂÇ§)", "  [3]   3ïb(Ç—ÇÂÇ§)", "  [4]   4ïb(Ç—ÇÂÇ§)", "  [5]   5ïb(Ç—ÇÂÇ§)", "  [6]   6ïb(Ç—ÇÂÇ§)", "  [7]   7ïb(Ç—ÇÂÇ§)", "  [8]   8ïb(Ç—ÇÂÇ§)", "  [9]   ÉmÅ[ÉäÉ~ÉbÉg"};
	public void run(){
		Select3 w = new Select3( "ëIëâÊñ " , this.calc);
...
/*			Action num0 = new NumKey("  [0]   ÉmÅ[ÉäÉ~ÉbÉg", this.w, this.calc);
			Action num1 = new NumKey("  [1]   1ïb(Ç—ÇÂÇ§)", this.w, this.calc);
			Action num2 = new NumKey("  [2]   2ïb(Ç—ÇÂÇ§)", this.w, this.calc);
			Action num3 = new NumKey("  [3]   3ïb(Ç—ÇÂÇ§)", this.w, this.calc);
			Action num4 = new NumKey("  [4]   4ïb(Ç—ÇÂÇ§)", this.w, this.calc);
			Action num5 = new NumKey("  [5]   5ïb(Ç—ÇÂÇ§)", this.w, this.calc);
			Action num6 = new NumKey("  [6]   6ïb(Ç—ÇÂÇ§)", this.w, this.calc);
			Action num7 = new NumKey("  [7]   7ïb(Ç—ÇÂÇ§)", this.w, this.calc);
			Action num8 = new NumKey("  [8]   8ïb(Ç—ÇÂÇ§)", this.w, this.calc);
			Action num9 = new NumKey("  [9]   9ïb(Ç—ÇÂÇ§)", this.w, this.calc);
...
*/
			...
			Action num7 = new NumKey("  [7]   7ïb(Ç—ÇÂÇ§)", this.w, this.calc);
			Action num8 = new NumKey("  [8]   8ïb(Ç—ÇÂÇ§)", this.w, this.calc);
			Action num9 = new NumKey("  [9]   ÉmÅ[ÉäÉ~ÉbÉg", this.w, this.calc);
			this.imap.put(KeyStroke.getKeyStroke("1"), num1);
			this.imap.put(KeyStroke.getKeyStroke("2"), num2);
			this.imap.put(KeyStroke.getKeyStroke("3"), num3);
			this.imap.put(KeyStroke.getKeyStroke("4"), num4);
