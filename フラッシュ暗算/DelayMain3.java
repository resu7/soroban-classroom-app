...
public class DelayMain3 extends JFrame implements Runnable{
	...
	public void run(){
		DelayMain3 w = new DelayMain3( "‘I‘ð‰æ–Ê3" , this.calc);
	...
	public DelayMain3( String title, CalcTest_pre calc ){
		super( title );
	...
	class ClickAction extends AbstractAction implements ActionListener {
		private DelayMain3 w;
		private double num;
		private String str;
		private InputMap imap;
		private ActionMap amap;
		private CalcTest_pre calc;
		public ClickAction( DelayMain3 w, int index, InputMap imap, ActionMap amap, CalcTest_pre calc){
			this.w = w;
			this.imap = imap;
			this.amap = amap;
			this.calc = calc;
			...
			String str = "  [" + this.str + "]   " + this.num + "  •b";
	...
	class NumKey extends AbstractAction{
		...
		private DelayMain3 w;
		private CalcTest_pre calc;
		public NumKey(String num, DelayMain3 w, CalcTest_pre calc){
			this.num = num;
			this.w = w;
			this.calc = calc;
