...
public class Select extends JFrame implements Runnable{
	...
	private String[] aa = {"","  [1]   ‘«‚µŽZ(‚½‚µ‚´‚ñ)", "  [2]   ˆø‚«ŽZ(‚Ð‚«‚´‚ñ)", "  [3]   Š|‚¯ŽZ(‚©‚¯‚´‚ñ)", "  [4]   Š„‚èŽZ(‚í‚è‚´‚ñ)"};
	public void run(){
...
//	class RadioAction extends AbstractAction{
	class ClickAction extends AbstractAction implements ActionListener {
		...
		public ClickAction( Select w, int index, InputMap imap, ActionMap amap, CalcTest_pre calc){
			...
			Action num1 = new NumKey("  [1]   ‘«‚µŽZ(‚½‚µ‚´‚ñ)", this.w, this.calc);
			Action num2 = new NumKey("  [2]   ˆø‚«ŽZ(‚Ð‚«‚´‚ñ)", this.w, this.calc);
			Action num3 = new NumKey("  [3]   Š|‚¯ŽZ(‚©‚¯‚´‚ñ)", this.w, this.calc);
			Action num4 = new NumKey("  [4]   Š„‚èŽZ(‚í‚è‚´‚ñ)", this.w, this.calc);
