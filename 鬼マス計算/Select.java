...
public class Select extends JFrame implements Runnable{
	private String[] aa = {"","  [1]   1ケタ＋1ケタ", "  [2]   2ケタ＋1ケタ", "  [3]   2ケタ＋2ケタ", "  [4]   3ケタ＋2ケタ", "  [5]   3ケタ＋3ケタ", "  [6]   4ケタ＋4ケタ"};
	...
	class ClickAction extends AbstractAction{
		...
		public ClickAction( Select w, int index, InputMap imap, ActionMap amap, CalcTest_pre calc){
			...
			Action num3 = new NumKey("  [3]   2ケタ＋2ケタ", this.w, this.calc);
			Action num4 = new NumKey("  [4]   3ケタ＋2ケタ", this.w, this.calc);
			Action num5 = new NumKey("  [5]   3ケタ＋3ケタ", this.w, this.calc);
			Action num6 = new NumKey("  [6]   4ケタ＋4ケタ", this.w, this.calc);
