...
public class Select2b extends JFrame implements Runnable{
	...
	private String[] aa = {"","  [1]   たてのケタが大きい(おおきい)", "  [2]   よこのケタが大きい(おおきい)"};
	public void run(){
		Select2b w = new Select2b( "選択画面" , this.calc);
	...
	class ClickAction extends AbstractAction{
		...
		public ClickAction( Select2b w, int index, InputMap imap, ActionMap amap, CalcTest_pre calc){
			...
			Action num1 = new NumKey("  [1]   たてのケタが大きい(おおきい)", this.w, this.calc);
			Action num2 = new NumKey("  [2]   よこのケタが大きい(おおきい)", this.w, this.calc);
